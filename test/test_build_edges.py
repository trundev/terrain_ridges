...
def test_prepare_edges(altitude_grid, batch_size):
    ...
    for edges, keys in build_edges.prepare_edges(altitude_grid, batch_size=batch_size):
        # Test shapes
...
def test_build_edge_list(altitude_grid):
    """Test build_edge_list edge/node order"""
    main_edge_list, _ = build_edges.build_edge_list(altitude_grid)
