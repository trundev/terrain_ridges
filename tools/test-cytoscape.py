...
def visualize_graph_hierarchy(graph_list: list[np.array], edge_list: np.array, edge_src_mask: np.array, *,
...
def build_cytoscape_elements(par_nodes: np.array, edge_list: np.array, edge_src_mask: np.array, edge_layer: np.array, *,
    ...
    ghost_mask = ~edge_src_mask.any(0) if top_layer else np.zeros_like(edge_src_mask[0])
